...
public class BoarEnemy extends Enemy implements CollidableActor {
	...
	public BoarEnemy(int x, int y){
		...
		if(BoarEnemy.imgSource==null ){
			BoarEnemy.setImgSource("/boar.png");

		}
		if(BoarEnemy.sheet == null && BoarEnemy.imgSource != null){
			BoarEnemy.sheet = new SpriteSheet(getImgSource());
		}
		...
		this.moveAnim.addNewFrame(sheet,64,64,1,10);
		this.moveAnim.addNewFrame(sheet,64,64,2,5);
		this.moveAnim.addNewFrame(sheet,64,64,3,10);
		this.moveAnim.addNewFrame(sheet,64,64,2,5);
		this.moveAnim.addNewFrame(sheet,64,64,1,10);
